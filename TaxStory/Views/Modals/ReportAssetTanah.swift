//
//  ReportAssetTanah.swift
//  TaxStory
//
//  Created by Verrell Sutanto on 06/07/23.
//

import SwiftUI

struct ReportAssetTanahView: View {
    
    @Binding var modalPresentTanah : Bool
    ...
    @Binding var modalTanahAppended : Bool
...
//                                        }
                                        ...
                                        listGambar.append("ListTanah")
                                        modalTanahAppended = true
                                    }label: {
                                        Image("ButtonPlus")
                                            .resizable()
                                            .scaledToFit()
...
struct ReportAssetTanahView_Previews: PreviewProvider {
    static var previews: some View {
        ReportAssetTanahView(modalPresentTanah: .constant(false), listGambar: .constant(["ListTanah"]), modalTanahAppended: .constant(false))
